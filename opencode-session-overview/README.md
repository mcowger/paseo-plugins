...
public Paseo `0.7.0-beta.2` agent SDK to show the native OpenCode session ID, current usage,
...
The plugin targets Paseo `v0.7.0-beta.2` and requires an OpenCode agent in Paseo.
